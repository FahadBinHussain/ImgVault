  ...
  const runSceneIntegrityCheck = useCallback(async () => {
    ...
    try {
      ...
      setNotice({
        ...
        message: `3D Scene check: ${combined.found.length} found, ${combined.missing.length} broken, ${combined.noUrl.length} no url, ${combined.extra.length} extra.`,
      });
    } catch (err) {
          ...
          <>
            <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div className="space-y-2">
                ...
                <h1 className="text-3xl font-semibold tracking-tight text-base-content">3D Scene files (.spz)</h1>
              </div>
